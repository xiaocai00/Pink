 ...
 */
public class KruskalFileInputFormat extends FileInputFormat<IntWritable, EdgeWritable> {
  @Override
  ...
  @Override
  public RecordReader<IntWritable, EdgeWritable> createRecordReader(
      InputSplit inputSplit, TaskAttemptContext context) throws IOException,
      InterruptedException {
    KruskalRecordReader reader = new KruskalRecordReader();
    return reader;
  }
